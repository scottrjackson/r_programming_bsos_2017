...
## Completing the Final Project {.smaller}
  - the Final Project has several requirements:
    - proposal due 11:59 PM EST, Sunday, January 15
    - proposal revision (if needed) due by time specified by instructor
    - final code due 8:00 PM EST, Tuesday, January 24
...
## Testing version control {.smaller}
  ...
  - Version Control
  - Git
  - https://github.com/scottrjackson/r_programming_bsos_winter2017.git
...
## Send it to me {.smaller}
  ...
  - BEFORE 9am 1/10/2017 (I will check email timestamps)
